...
Revision ID: 3e2d0c703668
Revises: 
Create Date: 2024-12-24 15:52:26.650280
...
def upgrade() -> None:
    ...
    sa.Column('signing_order', sa.Enum('PARALLEL', 'SEQUENTIAL', name='signingorder'), nullable=True),
    ...
    sa.Column('page_no', sa.String(), nullable=True),
